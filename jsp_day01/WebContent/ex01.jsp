...
<body>
	...
	<h2>
		표현식 :
		<%=answer%></h2>
	<h3 style="margin-bottom: 0px">jsp -> html로 변경 시키는 경로 및 파일</h3>
	경로 : D:\10월	취업\jsp\workspace-jsp\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\day01\org\apache\jsp
	...
	<table border="1" cellpadding="10" cellspacing="0">
		...
		<tr>
			...
			<td>&lt;%= n1 %>, &lt;%= add(10, 20) %></td>
			<td>변수 혹은 함수의 값을 HTML에 출력한다. out.print()와 동일하다</td>
		</tr>
		<tr>
			<td>comment, 주석</td>
			<td>&lt;%-- JSP주석~~~ --%></td>
