...
public class Ex02 {
	public static void main(String[] args) {
		...
		int arr2[];		// C언어에서는 변수이름 뒤에 []를 작성해야만 한다. (자바는 둘 다 가능)
		...
		int[] arr5 = new int[5];
		// 배열의 요소를 명시하지 않고, 빈칸만으로 배열을 생성할 수도 있으면, 길이가 필요함
		// 이 때, 배열 멤버 요소의 초기값은 자료형에 맞는 0값으로 생성됨
		
//		int[] arr6 = new int[5] { 1, 2, 3, 4, 5 };
		// 배열을 생성할 때는 길이 혹은 요소를 명시하면, 둘 다 명시하면 문법상 틀림
