...
public class Ex03 {
	public static void main(String[] args) {
		...
		String s4 = s2.substring(s2.indexOf("search"), s2.lastIndexOf("search.naver")-1);
		...
		// 각 대상의 내용이 똑같은가
		System.out.println("t1.equals(t2) : " + t1.equals(t2));		// 문자열 내용(참조자료형)만 비교를 하기 위해선 .equals함수 이용!
		System.out.println("t1.equals(t3) : " + t1.equals(t3));		// 가리키는 대상은 달라도 내용이 같으면 true
	}
}