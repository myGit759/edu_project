...
public class Ex06 {
	public static void main(String[] args) {
		...
		// 내부 원소(element)가 Object가 타입이면, 객체 메서드를 호출하기 위해 일일이 다운캐스팅을 해야한다
		...
		// 향상된 for문 (index를 사용하지 않는 for문, forEach라고도 하지만 함수이름과 중복되므로...)
		// Iterable 한 타입에 대해서 적용할 수 있다 (배열 포함)
		...
		list3.forEach(element -> element.show());// forEach를 쓰면 자동으로 슈퍼클래스가 지정이 되는가?
		System.out.println();
