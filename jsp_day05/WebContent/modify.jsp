	...
	<form method="POST">
		...
		<p>
			<select name="category" required>
				...
				<option ${food.category == '분식' ? 'selected' : null }>분식</option>
		...
		<p><input type="text" name="storeName" value="${food.storeName }" required autofocus></p>
		<p><input type="text" name="menuName"  value="${food.menuName }" required></p>
		<p><input type="number" name="price"  value="${food.price }" min="0" step="100" required ></p>
